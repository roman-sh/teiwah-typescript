...
export interface Env {
  TEIWAH_SESSION_API_KEY?: string | undefined;

  TEIWAH_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  TEIWAH_SESSION_API_KEY: z.optional(z.string()),

  TEIWAH_DEBUG: z.optional(z.coerce.boolean()),
});
